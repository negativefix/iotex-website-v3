...
const IopayBg = (props) => {
    return (
        <Box {...props}>
            <Image src="/images/iopay_group.png" alt="iopay pc bg" />
        </Box>
    )
}


const DesktopItem = ({href, ...restProps}) => <chakra.a href={href} display="flex" alignItems="center" justifyContent="center" cursor="pointer" background="rgba(255, 255, 255, 0.05)"
    ...
    return (
        <Box {...props}>
            ...
            <Box mt="55px">
                ...
                <Flex mt="16px">
                    <chakra.a href={publicConfig.IOPAY_IOS_DOWNLOAD}><MobileItem w="179px" h="60px" src="/images/iopay_appstore.svg" /></chakra.a>
                    <chakra.a href={publicConfig.IOPAY_GOOGLE_DOWNLOAD}><MobileItem ml="16px" w="201px"  h="60px" src="/images/iopay_googleplay.svg" /></chakra.a>
                    <chakra.a href={publicConfig.IOPAY_APK_DOWNLOAD}><MobileItem ml="16px" w="200px"  h="60px"src="/images/iopay_apk.svg" /></chakra.a>
                    <chakra.a href={publicConfig.IOPAY_MIRROR_DOWNLOAD}><MobileItem ml="16px" w="60px" h="60px" src="/images/iopay_mirrorcn.svg" /></chakra.a>
                </Flex>
            </Box>
            <Box mt="53px">
                ...
                <Flex mt="16px">
                    <DesktopItem href={packages?.mac}>
                        <Image w="32px" h="32px" mr="8px" src="/images/iopay_mac.svg" alt="" />MacOS
                    </DesktopItem>
                    <DesktopItem ml="16px"  href={packages?.window}>
                        <Image w="32px" h="32px" mr="8px" src="/images/iopay_windows.svg" alt="" />Windows
                    </DesktopItem>
                    <DesktopItem ml="16px" href={packages?.linux}>
                        <Image w="32px" h="32px" mr="8px" src="/images/iopay_linux.svg" alt="" />Linux
                    </DesktopItem>
                </Flex>
            </Box>
            <Text>
        ...
        <Flex minH="100vh" direction="column">
            <Box pb="70px" background="#2F343B" flex="auto">
                <Flex pl="64px" alignItems="center" pt="48px">
                    <Image ml="12px" w="31px" h="29px" src="/images/iopay_logo.svg" alt="" />
            ...
            <Flex wrap="wrap" align="center" h="276px" background={`#2F343B url(/images/iopay_bottom_bg.png) no-repeat`}>
                <DescItem title={lang.t(`iopay.experience.title`)} content={lang.t(`iopay.experience.content`)} imgUrl="/images/iopay_icon_experience.svg" />
                <DescItem title={lang.t(`iopay.safe.title`)} content={lang.t(`iopay.safe.content`)} imgUrl="/images/iopay_icon_safe.svg" />
                <DescItem title={lang.t(`iopay.integrated.title`)} content={lang.t(`iopay.integrated.content`)} imgUrl="/images/iopay_icon_integrated.svg" />
            </Flex>
        </Flex>
    )
})
