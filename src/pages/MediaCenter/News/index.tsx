	...
	return (
		<>
			...
			<SectionContainer marginTop={'2rem'}>
				<Text fontSize={'2rem'} paddingLeft={{base:'0',md:'50px',lg:'60px',sm:'50px'}} fontWeight={'600'}>Feature Article</Text>
				<Box marginTop={'40px'}>
					<Carousel
			...
			<SectionContainer marginTop={'12rem'}>
				<Text fontSize={'2rem'} paddingLeft={{base:'0px',sm:'50px',md:'50px',lg:'60px'}}>In the News</Text>
				<SimpleGrid columns={[1, 2, 2]} spacing={{md: '28px', lg: '58px'}} marginTop={'40px'} paddingLeft={{base:'0',md:'50px',lg:'60px'}} spacingY={{base:'2rem'}}>
					{
				...
				</SimpleGrid>
				{
					store.showMore ? (
						<Flex alignItems={'center'} flexDirection={'column'} marginTop={'12rem'} cursor={'pointer'} onClick={()=>store.loadMore()}>
							<Text color={'#44FFB2'} fontSize={'28px'}>{lang.t('media.read.more')}</Text>
