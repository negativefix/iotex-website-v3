    ...
    return (
        <Box position="relative" pt={{base: "6rem", md: "4rem", lg: "5rem", xl: "6rem", "2xl": "5rem"}}>
            ...
            <Box position="absolute" zIndex="2" w="100%" h="100%" top="0" left="0">
                <Box w={{base: "25vw", md: "25vw", lg: "28vw"}} position="absolute" top="20%" left="10%" css={{animation: 'bigBall 1.5s linear infinite alternate running'}}>
                  <img src="/images/bigball.png" alt="" />
                </Box>
                <Box w={{base: "8vw", md: "8vw", lg: "12vw"}}  position="absolute" left="75%" top="50%" css={{ animation: 'smallBall 1.5s linear infinite alternate running'}}>
