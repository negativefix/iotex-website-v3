...
function parseImportModule(code, libList) {
        ...
        astBody.forEach((astNode, index) => {
            ...
            if (astNode.type === 'ImportDeclaration' && matchLib) {
                astNode.specifiers.forEach((item) => {
                    ...
                    const libDirectory = (matchLib === null || matchLib === void 0 ? void 0 : matchLib.libDirectory) || 'es';
                    newImportStatement += `import ${localName} from '${libName}/${libDirectory}/${param_case_1.paramCase(name)}'\n`;
...
const addImportToCode = (code, impConfig, removeoldImport = false) => {
